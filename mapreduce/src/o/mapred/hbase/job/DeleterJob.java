...
import o.mapred.hbase.mapper.DeleterMapper;
...
public class DeleterJob extends Configured implements Tool {
    public static final Logger LOG = LoggerFactory.getLogger(DeleterJob.class);
    public static final String NAME = DeleterJob.class.getName();
    ...
    public int run(String[] args) throws Exception {
        ...
        Job job = new Job(conf, "- Delete from " + table + " " + family + ":" + column + " value = " + value);
        ...
        job.setJarByClass(DeleterJob.class);
        job.setMapperClass(DeleterMapper.class);
        //job.setReducerClass(reducerClassName);
        ...
        TableMapReduceUtil.initTableMapperJob(table, scan, DeleterMapper.class, ImmutableBytesWritable.class, Writable.class, job);
    ...
    public static void main(String[] args) throws Exception {
        ...
        int ret = ToolRunner.run(new DeleterJob(), args);
