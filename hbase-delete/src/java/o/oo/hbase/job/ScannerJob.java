...
public class ScannerJob extends Configured implements Tool {
	public static final Logger LOG = LoggerFactory.getLogger(ScannerJob.class);
	public static final String NAME = ScannerJob.class.getName();
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(ScannerJob.class);
	...
	public static void main(String[] args) throws Exception {
		...
		int ret = ToolRunner.run(new ScannerJob(), args);
